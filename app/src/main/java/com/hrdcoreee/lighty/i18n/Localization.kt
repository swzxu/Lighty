...
val EnStrings = Strings(
    ...
    offlineHint = "The controller is unavailable. Check its power and that it is nearby.",
...
val RuStrings = Strings(
    ...
    offlineHint = "Контроллер недоступен. Проверьте питание и что он находится рядом.",
    permTitle = "Нужен доступ к Bluetooth",
    permMessage = "Чтобы найти ваш контроллер и управлять им, приложению нужно разрешение на поиск устройств поблизости.",
    allow = "Разрешить",
